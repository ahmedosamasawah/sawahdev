...
export const buttonVariants = tv({
    ...
    variants: {
        variant: {
            ...
            link: 'text-foreground decoration-foreground/70 hover:decoration-foreground underline decoration-dotted decoration-1 underline-offset-2 transition-all hover:decoration-solid',
        },
        size: {
