...
قدمت Svelte 5 مفهوم _الرونز_، وهو نموذج تفاعلي أبسط وأكثر قابلية للتوقع. إذا كان الإصدار الثالث يشعر بالسحر، فإن الإصدار الخامس يشعر بالوضوح، ويمكن تتبعه بسهولة داخل الفرق، ويجعل الرسم البياني للبيانات واضحاً بلا مفاجآت خفية.
...
const has_filters = $derived(
	filter_state.search.length > 0 || filter_state.tag_ids.length > 0 || filter_state.only_featured
);
